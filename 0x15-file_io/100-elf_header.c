 ...
 * @e_ident: An array pointer containing magic numbers of the ELF
 *
 ...
 * ELF header
 * @argc: This is the number of arguments supplied to program
 * @argv: Pointer arrays pointing to the arguments
 *
 * Return: 0 if successful
 *
 * Description: If the file is not an ELF File or
 * the function fails - with 98 as the exit code
 */
